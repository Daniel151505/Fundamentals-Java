...
public class DetalleDeFactura {
    public static void main(String[] args) {
        ...
        /*
        Obtener el nombre de la factura con los espacios
        usando el método nextLine();
        ...
        */
        ...
        utilizar método nextDouble() para obtener precios con decimales (,).
        */
        System.out.println("Ingrese un precio del producto");
        double precio1 = scanner.nextDouble();

        System.out.println("Ingrese un segundo precio del producto");
        ...
        String detalle = "La factura " + nombreFactura + " tiene un total bruto de " + totalBruto
